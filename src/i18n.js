...
(function () {
  ...
  var DICTS = {
    ar: {
      ...
      'diag.export': '⬇️ تصدير سجل التشخيص',
    ...
    en: {
      ...
      'diag.export': '⬇️ Export diagnostics log',
      ...
      'results.ambiguous': '⚠️ Ambiguous result: another substance with a different CAS number looks similar ({a} {va}% ↔ {b} {vb}%). Check the full name before any decision.',
    ...
    fr: {
      ...
      'diag.export': '⬇️ Exporter le journal de diagnostic',
      ...
      'results.ambiguous': '⚠️ Résultat ambigu : une autre substance avec un numéro CAS différent semble similaire ({a} {va}% ↔ {b} {vb}%). Vérifiez le nom complet avant toute décision.',
    ...
    zh: {
      ...
      'results.ambiguous': '⚠️ 结果不明确：存在CAS号不同的相似物质（{a} {va}% ↔ {b} {vb}%）。做出任何决定前请核对完整名称。',
