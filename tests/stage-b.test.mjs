...
check('version: 1.7.0 in version.json + package.json',
  JSON.parse(readFileSync(join(root, 'version.json'), 'utf8')).version === '1.7.0'
  && JSON.parse(readFileSync(join(root, 'package.json'), 'utf8')).version === '1.7.0');
